...
------------- | ------------- | -------------
[**enrollments_list**](EnrollmentApi.md#enrollments_list) | **GET** /enrollments/{registration_id} | 
...
# **enrollments_list**
> EnrollmentList enrollments_list(registration_id)



Return all enrollments of a student specified by its registration id
...
with osis_offer_enrollment_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.enrollments_list(registration_id)
        pprint(api_response)
...
with osis_offer_enrollment_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.my_enrollments_year_list(year, enrollment_state=enrollment_state, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id, limit=limit, offset=offset)
        pprint(api_response)
    except osis_offer_enrollment_sdk.ApiException as e:
        print("Exception when calling EnrollmentApi->my_enrollments_year_list: %s\n" % e)
```
